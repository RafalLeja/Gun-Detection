...
def test_classification_model_forward():
    ...
    backbone = MLPBackbone(input_shape=input_shape, hidden_dims=[128], output_dim=embed_dim)

    model = ClassificationModel(backbone=backbone, embed_dim=embed_dim, num_classes=num_classes, attribute=attribute)
...
def test_classification_model_training_step():
    ...
    attributes = {"target_class": torch.randint(0, num_classes, (batch_size,))}
